...
def two_circles():
    ...
    point2 = rg.Point(30, 50)
    circle2 = rg.Circle(point2, 5)
...
def circle_and_rectangle():
    ...
    window = rg.RoseWindow(400, 400)
    point = rg.Point(75, 75)
    circle = rg.Circle(point, 50)
    circle.fill_color = 'blue'
    circle.pen = rg.Pen('black', 10)
    point2 = rg.Point(50, 200)
    point3 = rg.Point(100, 300)
    rectangle = rg.Rectangle(point2, point3)
    rectangle.pen = rg.Pen('black', 10)
    ...
    print('10')
    print('blue')
    print('point(75.0, 75.0)')
    print('75')
    print('75')
    print('10')
    print('None')
    print('point(75.0, 250.0)')
    print('75')
    print('250')
